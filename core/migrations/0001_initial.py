# Generated by Django 5.2 on 2025-10-06 09:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('event_type', models.CharField(max_length=100, primary_key=True, serialize=False, verbose_name='Bildirim Olay Tipi (Anahtar)')),
                ('is_active', models.BooleanField(default=True, help_text='Bu bildirim türü aktifse Redis üzerinden gönderilir. Pasif ise gönderilmez.', verbose_name='Aktif Mi?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_provider', models.CharField(choices=[('none', 'Entegrasyon Yok'), ('iyzico', 'Iyzico'), ('paytr', 'PayTR')], default='none', max_length=20, verbose_name='Ödeme Sağlayıcı')),
                ('payment_api_key', encrypted_model_fields.fields.EncryptedCharField(blank=True, null=True, verbose_name='Ödeme Sağlayıcı API Anahtarı')),
                ('payment_secret_key', encrypted_model_fields.fields.EncryptedCharField(blank=True, null=True, verbose_name='Ödeme Sağlayıcı Gizli Anahtarı')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about_image', models.URLField(blank=True, max_length=1024, null=True, verbose_name='Hakkımızda Görseli')),
                ...
                ('allow_reservations', models.BooleanField(default=False, verbose_name='Online Rezervasyona İzin Ver')),
                ('allow_online_ordering', models.BooleanField(default=False, verbose_name='Online Siparişe İzin Ver')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.DecimalField(decimal_places=8, max_digits=10, verbose_name='Enlem')),
                ('longitude', models.DecimalField(decimal_places=8, max_digits=11, verbose_name='Boylam')),
                ('radius_meters', models.FloatField(default=100.0, verbose_name='Yarıçap (Metre)')),
                ('is_active', models.BooleanField(default=True, verbose_name='Aktif Mi?')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='check_in_locations', to='core.business', verbose_name='İşletme')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_price', models.DecimalField(blank=True, decimal_places=3, max_digits=10, null=True, verbose_name='Birim Maliyet Fiyatı')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('expires_at', models.DateTimeField(blank=True, null=True, verbose_name='Geçerlilik Bitiş Tarihi')),
                ('is_active', models.BooleanField(default=True, verbose_name='Aktif Mi?')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qr_codes', to='core.checkinlocation', verbose_name='Lokasyon')),
            ],
            options={
                'verbose_name': 'QR Kod',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pos_x', models.FloatField(blank=True, null=True, verbose_name='X Koordinatı')),
                ('pos_y', models.FloatField(blank=True, null=True, verbose_name='Y Koordinatı')),
                ...
                ('layout', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tables_on_layout', to='core.businesslayout')),
            ],
            options={
                'verbose_name': 'Masa',
        ...
        migrations.AddField(
            model_name='ingredient',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.unitofmeasure', verbose_name='Ölçü Birimi'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('check_in', 'Giriş'), ('check_out', 'Çıkış')], max_length=10, verbose_name='Giriş/Çıkış Tipi')),
                ...
                ('notes', models.TextField(blank=True, null=True, verbose_name='Notlar')),
                ('qr_code_data', models.UUIDField(blank=True, null=True, verbose_name='QR Kod Verisi')),
                ('is_manual_entry', models.BooleanField(default=False, verbose_name='Manuel Giriş Mi?')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendance_records', to=settings.AUTH_USER_MODEL, verbose_name='Personel')),
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendance_records', to='core.business', verbose_name='İşletme')),
                ('check_in_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attendance_records', to='core.checkinlocation', verbose_name='Check-in Lokasyonu')),
            ],
            options={
                'verbose_name': 'Personel Giriş-Çıkış Kaydı',
                'verbose_name_plural': 'Personel Giriş-Çıkış Kayıtları',
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['user', 'business', '-timestamp'], name='core_attend_user_id_8fe4c7_idx'), models.Index(fields=['business', '-timestamp'], name='core_attend_busines_b25189_idx'), models.Index(fields=['type', '-timestamp'], name='core_attend_type_94104d_idx')],
            },
        ),
        migrations.CreateModel(
